        ...
        1: [function (a, b, c) {
            ...
            function l(a) {
                return new ma(function (b) {
                    var c = a.transaction(na, qa), d = g([""]);
                    c.objectStore(na).put(d, "key"), c.onabort = function (a) {
            ...
            function m(a) {
                return "boolean" == typeof ka ? ma.resolve(ka) : l(a).then(function (a) {
                    return ka = a
                })
            }
            ...
            function o(a) {
                var b = la[a.name], c = b.deferredOperations.pop();
                c && c.resolve()
            }

            function p(a, b) {
                var c = la[a.name], d = c.deferredOperations.pop();
                d && d.reject(b)
            }
            ...
            function q(a, b) {
                return new ma(function (c, d) {
                    ...
                    b && (f.onupgradeneeded = function (b) {
                        var c = f.result;
                        try {
                            c.createObjectStore(a.storeName), b.oldVersion <= 1 && c.createObjectStore(na)
                        } catch (c) {
            ...
            function y(a) {
                n(a);
                for (var b = la[a.name], c = b.forages, d = 0; d < c.length; d++)c[d]._dbInfo.db && (c[d]._dbInfo.db.close(), c[d]._dbInfo.db = null);
            ...
            function A(a) {
                ...
                f || (f = {
                    ...
                    dbReady: null,
                    deferredOperations: []
                }, la[d.name] = f), f.forages.push(c), c._initReady || (c._initReady = c.ready, c.ready = x);
                for (var g = [], h = 0; h < f.forages.length; h++) {
                    var i = f.forages[h];
                    i !== c && g.push(i._initReady().catch(b))
                }
                var j = f.forages.slice(0);
                return ma.all(g).then(function () {
            ...
            function C(a, b) {
                var c = this, d = new ma(function (b, d) {
                    c.ready().then(function () {
                        z(c._dbInfo, pa, function (e, f) {
                            if (e)return d(e);
                            try {
            ...
            function D(a, b, c) {
                ...
                var e = new ma(function (c, e) {
                    ...
                    d.ready().then(function () {
                        return f = d._dbInfo, "[object Blob]" === oa.call(b) ? m(f.db).then(function (a) {
                            return a ? b : u(b)
                        }) : b
                    }).then(function (b) {
                        z(d._dbInfo, qa, function (f, g) {
                            if (f)return e(f);
                            try {
                                var h = g.objectStore(d._dbInfo.storeName), i = h.put(b, a);
                                null === b && (b = void 0), g.oncomplete = function () {
                                    void 0 === b && (b = null), c(b)
            ...
            function F(a) {
                var b = this, c = new ma(function (a, c) {
                    b.ready().then(function () {
                        z(b._dbInfo, qa, function (d, e) {
                            if (d)return c(d);
                            try {
            ...
            function K(a) {
                ...
                for (b = 0; b < h; b += 4)c = sa.indexOf(a[b]), d = sa.indexOf(a[b + 1]), e = sa.indexOf(a[b + 2]), f = sa.indexOf(a[b + 3]), k[i++] = c << 2 | d >> 4, k[i++] = (15 & d) << 4 | e >> 2, k[i++] = (3 & e) << 6 | 63 & f;
                return j
            }

            function L(a) {
                var b, c = new Uint8Array(a), d = "";
                for (b = 0; b < c.length; b += 3)d += sa[c[b] >> 2], d += sa[(3 & c[b]) << 4 | c[b + 1] >> 4], d += sa[(15 & c[b + 1]) << 2 | c[b + 2] >> 6], d += sa[63 & c[b + 2]];
                return c.length % 3 == 2 ? d = d.substring(0, d.length - 1) + "=" : c.length % 3 == 1 && (d = d.substring(0, d.length - 2) + "=="), d
            }

            function M(a, b) {
                var c = "";
                if (a && (c = Ja.call(a)), a && ("[object ArrayBuffer]" === c || a.buffer && "[object ArrayBuffer]" === Ja.call(a.buffer))) {
                    var d, e = va;
                    a instanceof ArrayBuffer ? (d = a, e += xa) : (d = a.buffer, "[object Int8Array]" === c ? e += za : "[object Uint8Array]" === c ? e += Aa : "[object Uint8ClampedArray]" === c ? e += Ba : "[object Int16Array]" === c ? e += Ca : "[object Uint16Array]" === c ? e += Ea : "[object Int32Array]" === c ? e += Da : "[object Uint32Array]" === c ? e += Fa : "[object Float32Array]" === c ? e += Ga : "[object Float64Array]" === c ? e += Ha : b(new Error("Failed to get type for BinaryArray"))), b(e + L(d))
            ...
            function N(a) {
                ...
                var b, c = a.substring(Ia), d = a.substring(wa, Ia);
                if (d === ya && ua.test(c)) {
                    var e = c.match(ua);
                        ...
                        i.serializer.serialize(b, function (b, j) {
                            j ? g(j) : i.db.transaction(function (c) {
                                ...
                                if (b.code === b.QUOTA_ERR) {
                                    if (d > 0)return void f(R.apply(e, [a, h, c, d - 1]));
                                    g(b)
                                }
                            })
                        })
            ...
            function Z(a) {
                ...
                return c.keyPrefix = c.name + "/", c.storeName !== b._defaultConfig.storeName && (c.keyPrefix += c.storeName + "/"), b._dbInfo = c, c.serializer = Ka, ma.resolve()
            }
            ...
            var ia = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (a) {
                return typeof a
            } : function (a) {
                return a && "function" == typeof Symbol && a.constructor === Symbol && a !== Symbol.prototype ? "symbol" : typeof a
            }, ja = e();
            "undefined" == typeof Promise && a(3);
            var ka, la, ma = Promise, na = "local-forage-detect-blob-support", oa = Object.prototype.toString, pa = "readonly", qa = "readwrite", ra = {
                ...
                key: H,
                keys: I
            }, sa = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/", ta = "~~local_forage_type~", ua = /^~~local_forage_type~([^~]+)~/, va = "__lfsc__:", wa = va.length, xa = "arbf", ya = "blob", za = "si08", Aa = "ui08", Ba = "uic8", Ca = "si16", Da = "si32", Ea = "ur16", Fa = "ui32", Ga = "fl32", Ha = "fl64", Ia = wa + xa.length, Ja = Object.prototype.toString, Ka = {
                serialize: M,
                deserialize: N,
                stringToBuffer: K,
                bufferToString: L
                ...
                key: ba,
                keys: ca
            }, Na = Array.isArray || function (a) {
                    return "[object Array]" === Object.prototype.toString.call(a)
                }, Oa = {}, Pa = {}, Qa = {
                INDEXEDDB: ra,
                WEBSQL: La,
                LOCALSTORAGE: Ma
            }, Ra = [Qa.INDEXEDDB._driver, Qa.WEBSQL._driver, Qa.LOCALSTORAGE._driver], Sa = ["clear", "getItem", "iterate", "key", "keys", "length", "removeItem", "setItem"], Ta = {
                description: "",
                driver: Ra.slice(),
                name: "localforage",
                size: 4980736,
                ...
                function a(b) {
                    d(this, a);
                    for (var c in Qa)if (Qa.hasOwnProperty(c)) {
                        var e = Qa[c], f = e._driver;
                        this[c] = f, Oa[f] || this.defineDriver(e)
                    }
                    this._defaultConfig = ha({}, Ta), this._config = ha({}, this._defaultConfig, b), this._driverSet = null, this._initDriver = null, this._ready = !1, this._dbInfo = null, this._wrapLibraryMethodsWithReady(), this.setDriver(this._config.driver).catch(function () {
                    })
                }
                ...
                return a.prototype.config = function (a) {
                    ...
                    var d = new ma(function (b, c) {
                        try {
                            ...
                            for (var f = Sa.concat("_initStorage"), g = 0, h = f.length; g < h; g++) {
                                var i = f[g];
                                if (!i || !a[i] || "function" != typeof a[i])return void c(e)
                            }
                            var j = function (c) {
                                Oa[d] && console.info("Redefining LocalForage driver: " + d), Oa[d] = a, Pa[d] = c, b()
                            };
                    ...
                    var d = Oa[a] ? ma.resolve(Oa[a]) : ma.reject(new Error("Driver not found."));
                    return i(d, b, c), d
                    ...
                    for (var a = 0, b = Sa.length; a < b; a++)ga(this, Sa[a])
